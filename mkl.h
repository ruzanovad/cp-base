...
namespace bin_search
{
    ...
    double invariant_with_precision(double a, double b, double x, double eps = 1e-9);
...
namespace number_theory
{
    ...
    struct gcd_result
    {
        ...
        explicit gcd_result(unsigned long long x1 = 0ULL, unsigned long long p1 = 0, unsigned long long q1 = 0) : x(x1), p(p1), q(q1) {}
    };
    ...
    vector<pair<unsigned long long, unsigned long long>> factorize(unsigned long long x);

    unsigned long long bin_pow(unsigned long long a, unsigned long long p, unsigned long long mod);
